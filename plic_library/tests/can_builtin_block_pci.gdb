...
# this scenario tests whether failing to perform complete blocks all other irqs

# ANSWER: No, it only blocks the "uncompleted" irq
...
shell grep 'EBB$' /tmp/pci_uart.log && grep 'DA$' /tmp/uart.log && echo "SUCCESS" || echo "FAIL"
